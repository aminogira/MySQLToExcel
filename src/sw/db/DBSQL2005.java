...
import sw.RegQuery;
import sw.proConst;
//import ui.ProgramSetting;
import sw.ui.ProgramSetting;
//import ui.proConst;
//import amino.ui.util.FoundItem;
//import db.Envilop;

public class DBSQL2005 {
...
//		System.out.println("updateData@DB \n" + sql);
  ...
  public void updateData(Envilop env,String transType,int transId)throws SQLException {
    //String sql=env.getSQL();
    System.out.println("log list not updating 2005");
    updateData(env);
  }
...
//      Logger.getLogger(DB.class.getName()).log(Level.SEVERE, null, ex);
    ...
    try {
      ...
      con = DriverManager.getConnection("jdbc:jtds:sqlserver:/" + proConst.serverIp.trim() + ":" + RegQuery.SERVER_PORT.trim() + "/" + proConst.dbName.trim(), proConst.user.trim(), proConst.passwd.trim());
...
//	}
  ...
  public boolean isTableAvailabal(String tblName){
    System.out.println("DB2005.isTableAvailabal always return true");
    return true;
  }
//	public FoundItem[] getFoundItem(ResultSet rs,String showingData){
//		FoundItem fi[] = null;
